...
public class MainMenuView_ForUser extends javax.swing.JFrame {
    ...
    public MainMenuView_ForUser() {
        initComponents();
        list = new UserDAO().getListForUser();
       ...
       menuExit.setMnemonic(KeyEvent.VK_T);
       menuExit.setToolTipText("Bạn sẽ thoát khỏi chương trình");
       menuLogout.setMnemonic(KeyEvent.VK_N);
       menuLogout.setToolTipText("Bạn sẽ đăng xuất, trở về màn hình Login");
       menuUpdateInfo.setMnemonic(KeyEvent.VK_C);
       menuUpdateInfo.setToolTipText("Bạn sẽ được chuyển đến form Update");
        model = (DefaultTableModel) tblhienthiuser.getModel();
        //tieude
        model.setColumnIdentifiers(new Object[]{"STT", "Họ tên", "Năm sinh", "Giới tính",
            "Địa chỉ", "Chức vụ", "Mô tả"});
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(btnUpdateInfo, javax.swing.GroupLayout.PREFERRED_SIZE, 75, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    /**
     * HIển thị danh sách toàn bộ cán bộ
     */
...
//        }
    ...
    /**
     * hien thi danh sach sau khi tim kiem
     * @param list 
     */
