...
public class Delete extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (dao.deleteCv(ks) > 0) {
            int choose = JOptionPane.showConfirmDialog(rootPane, "Xóa thông tin thành công.\nBạn có muốn tiếp tục?", "Thông báo", JOptionPane.YES_NO_OPTION);
            ...
            JOptionPane.showConfirmDialog(rootPane, "Không thành công, vui lòng kiểm tra lại ID");
        }
